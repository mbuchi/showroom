...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'page.reporter.widget.webgl_missing': 'This device cannot display maps (WebGL2 unavailable)',
    ...
    // Publish page - IDX 3.01 portal package builder
    'page.publish.kicker': 'Portal publisher',
    'page.publish.intro':
      'Prepare a property listing as a portal-ready IDX 3.01 package for ImmoScout24, Homegate, newhome, and Flatfox. Fill in the listing, pick images from your gallery, and download the upload package.',
    ...
    'page.publish.magic.button': 'Magic fill',
    'page.publish.magic.busy': 'Writing…',
    'page.publish.magic.confirm': 'Replace current text?',
    'page.publish.magic.failed': 'Could not write the copy. Try again.',
    'page.publish.magic.rateLimited': 'Too many requests right now. Wait a moment and try again.',
    'page.publish.magic.hint':
      'Writes a title and description from the listing facts. Facts stay the source of truth; review before publishing.',
    ...
    'page.publish.unit.SELL': 'Total sale price',
    'page.publish.unit.SELLM2': 'Price per m2',
    'page.publish.unit.MONTHLY': 'Rent per month',
    'page.publish.unit.WEEKLY': 'Rent per week',
    'page.publish.unit.DAILY': 'Rent per day',
    'page.publish.unit.YEARLY': 'Rent per year',
    'page.publish.unit.M2YEARLY': 'Rent per m2 per year',
    ...
    'page.publish.agencyIdHint':
      'Issued by the portal with your listing contract. Leave empty if your software fills it in.',
    ...
    'page.publish.images.hint':
      'Pick up to 13 images from your gallery. They are converted to JPEG and packaged for the portal.',
    'page.publish.images.empty':
      'No gallery images yet. Capture exports in the reporter or save screenshots from the map apps first.',
    ...
    'page.publish.images.moveUp': 'Move {name} up',
    'page.publish.images.moveDown': 'Move {name} down',
    'page.publish.images.remove': 'Remove {name}',
    ...
    'page.publish.guide.smg.body':
      'Listings reach both portals through the SMG feed. With a pro listing contract you get an agency ID and FTP credentials. Upload the data and images folders to ftp.homegate.ch. The file replaces all your published ads, and runs are processed about three times a day.',
    'page.publish.guide.newhome.title': 'newhome',
    'page.publish.guide.newhome.body':
      'Business (FLEX) accounts can enable the import interface under My newhome, Services, Import interfaces, and upload this package with the generated credentials.',
    'page.publish.guide.flatfox.title': 'Flatfox',
    'page.publish.guide.flatfox.body':
      'Flatfox accepts IDX packages from property software and offers a REST API for organization accounts. Private listings can be created in the Flatfox web interface.',
    'page.publish.guide.disclaimer':
      'This page prepares a portal-ready package. Publication itself happens with your own portal contract and credentials.',
    ...
    'tour.publish_form_body':
      'Search an address to prefill parcel data, then complete the listing details.',
    'tour.publish_images_title': 'Pick images',
    'tour.publish_images_body':
      'Select up to 13 gallery exports. They are converted and packaged automatically.',
    'tour.publish_export_title': 'Export the package',
    'tour.publish_export_body':
      'Validation runs live. Download the ZIP and upload it to your portal account.',
  ...
  fr: {
    ...
    'page.reporter.widget.webgl_missing': 'Cet appareil ne peut pas afficher de cartes (WebGL2 indisponible)',
    ...
    // Page Publier - generateur de paquet IDX 3.01 pour les portails
    'page.publish.kicker': 'Publication portails',
    'page.publish.intro':
      'Préparez une annonce immobilière sous forme de paquet IDX 3.01 prêt pour ImmoScout24, Homegate, newhome et Flatfox. Complétez l’annonce, choisissez des images dans votre galerie et téléchargez le paquet à importer.',
    ...
    'page.publish.section.pricing': 'Prix',
    'page.publish.section.details': 'Caractéristiques',
    'page.publish.section.features': 'Équipements',
    'page.publish.section.contact': 'Contact et agence',
    'page.publish.offer.rent': 'Location',
    'page.publish.offer.sale': 'Vente',
    'page.publish.field.category': 'Catégorie',
    'page.publish.field.objectType': 'Type d’objet',
    'page.publish.field.refProperty': 'Référence (EGRID ou la vôtre)',
    'page.publish.field.street': 'Rue et numéro',
    'page.publish.field.zip': 'NPA',
    'page.publish.field.city': 'Localité',
    'page.publish.field.canton': 'Canton',
    'page.publish.field.country': 'Pays',
    'page.publish.field.situation': 'Situation',
    'page.publish.field.title': 'Titre de l’annonce',
    'page.publish.field.description': 'Description',
    'page.publish.field.availableFrom': 'Disponible dès le (JJ.MM.AAAA)',
    'page.publish.field.url': 'Site web',
    'page.publish.magic.button': 'Remplissage magique',
    'page.publish.magic.busy': 'Rédaction…',
    'page.publish.magic.confirm': 'Remplacer le texte actuel ?',
    'page.publish.magic.failed': 'Échec de la génération. Réessayer.',
    'page.publish.magic.rateLimited':
      'Trop de requêtes pour le moment. Patientez un instant et réessayez.',
    'page.publish.magic.hint':
      'Rédige un titre et une description à partir des données de l’annonce. Les données restent la source de vérité : relisez le texte avant de publier.',
    'page.publish.field.sellingPrice': 'Prix de vente',
    'page.publish.field.rentNet': 'Loyer net',
    'page.publish.field.rentExtra': 'Charges',
    'page.publish.field.priceUnit': 'Unité de prix',
    'page.publish.unit.SELL': 'Prix de vente total',
    'page.publish.unit.SELLM2': 'Prix par m2',
    'page.publish.unit.MONTHLY': 'Loyer par mois',
    'page.publish.unit.WEEKLY': 'Loyer par semaine',
    'page.publish.unit.DAILY': 'Loyer par jour',
    'page.publish.unit.YEARLY': 'Loyer par an',
    'page.publish.unit.M2YEARLY': 'Loyer par m2 et par an',
    ...
    'page.publish.field.surfaceLiving': 'Surface habitable (m2)',
    'page.publish.field.surfaceProperty': 'Surface du terrain (m2)',
    'page.publish.field.surfaceUsable': 'Surface utile (m2)',
    'page.publish.field.volume': 'Volume (m3)',
    'page.publish.field.yearBuilt': 'Année de construction',
    'page.publish.field.yearRenovated': 'Année de rénovation',
    'page.publish.field.numberOfFloors': 'Étages du bâtiment',
    'page.publish.field.agencyId': 'ID d’agence',
    'page.publish.agencyIdHint':
      'Attribué par le portail avec votre contrat de diffusion. Laissez vide si votre logiciel le complète.',
    'page.publish.field.agencyName': 'Nom de l’agence',
    'page.publish.field.agencyReference': 'Personne de contact',
    'page.publish.field.agencyPhone': 'Téléphone',
    'page.publish.field.agencyEmail': 'E-mail',
    'page.publish.field.visitName': 'Contact pour les visites',
    'page.publish.field.visitPhone': 'Téléphone pour les visites',
    'page.publish.field.visitRemark': 'Remarque sur les visites',
    'page.publish.feature.view': 'Vue',
    'page.publish.feature.fireplace': 'Cheminée',
    'page.publish.feature.cabletv': 'Télévision par câble',
    'page.publish.feature.elevator': 'Ascenseur',
    'page.publish.feature.childFriendly': 'Adapté aux enfants',
    'page.publish.feature.parking': 'Place de parc',
    'page.publish.feature.garage': 'Garage',
    'page.publish.feature.balcony': 'Balcon',
    'page.publish.feature.wheelchair': 'Accès en fauteuil roulant',
    'page.publish.feature.animalAllowed': 'Animaux admis',
    'page.publish.feature.newBuilding': 'Construction neuve',
    'page.publish.feature.oldBuilding': 'Bâtiment ancien',
    'page.publish.feature.swimmingpool': 'Piscine',
    'page.publish.feature.minergieGeneral': 'Construction Minergie',
    'page.publish.feature.minergieCertified': 'Certifié Minergie',
    'page.publish.images.title': 'Images de l’annonce',
    'page.publish.images.hint':
      'Choisissez jusqu’à 13 images de votre galerie. Elles sont converties en JPEG et intégrées au paquet destiné au portail.',
    'page.publish.images.empty':
      'Aucune image dans la galerie. Créez d’abord des exports dans le Reporter ou enregistrez des captures depuis les applications cartographiques.',
    'page.publish.images.count': '{n}/13 sélectionnées',
    'page.publish.images.titlePlaceholder': 'Titre de l’image (facultatif)',
    'page.publish.images.failed': 'Certaines images n’ont pas pu être préparées : {names}',
    'page.publish.images.moveUp': 'Déplacer {name} vers le haut',
    'page.publish.images.moveDown': 'Déplacer {name} vers le bas',
    'page.publish.images.remove': 'Retirer {name}',
    'page.publish.validation.title': 'Validation',
    'page.publish.validation.ok': 'Prêt pour l’export. Tous les champs requis sont renseignés.',
    'page.publish.issue.refRequired': 'Une référence d’objet est obligatoire.',
    'page.publish.issue.zipInvalid': 'Les NPA suisses comptent 4 chiffres.',
    'page.publish.issue.cityRequired': 'La localité est obligatoire.',
    'page.publish.issue.countryInvalid': 'Le pays doit être un code à 2 lettres.',
    'page.publish.issue.titleRequired': 'Un titre d’annonce est obligatoire.',
    'page.publish.issue.descriptionRequired': 'Une description est obligatoire.',
    'page.publish.issue.typeRequired': 'Choisissez un type d’objet.',
    'page.publish.issue.priceUnitMismatch': 'L’unité de prix ne correspond pas au type d’offre.',
    'page.publish.issue.dateInvalid': 'Utilisez le format JJ.MM.AAAA.',
    'page.publish.issue.yearInvalid': 'Les années comptent 4 chiffres.',
    'page.publish.issue.agencyIdMissing':
      'Aucun ID d’agence. Les portails refusent les envois sans identifiant.',
    'page.publish.issue.priceOnRequest':
      'Aucun prix indiqué. L’annonce affichera « prix sur demande ».',
    'page.publish.issue.noStreet': 'Sans rue, l’annonce n’obtient pas de repère sur la carte.',
    'page.publish.issue.noImages': 'Aucune image sélectionnée.',
    'page.publish.issue.titleTruncated': 'Le titre est coupé à {max} caractères.',
    'page.publish.issue.descriptionTruncated': 'La description est coupée à {max} caractères.',
    'page.publish.issue.priceUnitDefaulted':
      'Aucune unité de prix définie. La valeur par défaut du portail s’applique.',
    'page.publish.export.title': 'Export',
    'page.publish.export.package': 'Télécharger le paquet portail (.zip)',
    'page.publish.export.unload': 'Télécharger unload.txt',
    'page.publish.export.copy': 'Copier l’enregistrement IDX',
    ...
    'page.publish.guide.smg.title': 'ImmoScout24 et Homegate (SMG)',
    'page.publish.guide.smg.body':
      'Les annonces arrivent sur les deux portails via le flux SMG. Avec un contrat de diffusion professionnel, vous recevez un ID d’agence et des accès FTP. Déposez les dossiers data et images sur ftp.homegate.ch. Le fichier remplace toutes vos annonces publiées et les traitements ont lieu environ trois fois par jour.',
    'page.publish.guide.newhome.title': 'newhome',
    'page.publish.guide.newhome.body':
      'Les comptes professionnels (FLEX) peuvent activer l’interface d’import sous My newhome, Services, Interfaces d’import, puis y déposer ce paquet avec les accès générés.',
    'page.publish.guide.flatfox.title': 'Flatfox',
    'page.publish.guide.flatfox.body':
      'Flatfox accepte les paquets IDX issus des logiciels immobiliers et propose une API REST pour les comptes d’organisation. Les annonces privées se saisissent directement dans l’interface web de Flatfox.',
    'page.publish.guide.disclaimer':
      'Cette page prépare un paquet prêt pour les portails. La publication se fait avec votre propre contrat et vos propres accès.',
    ...
    'tour.publish_form_title': 'Décrivez l’objet',
    'tour.publish_form_body':
      'Recherchez une adresse pour préremplir les données de la parcelle, puis complétez les détails de l’annonce.',
    'tour.publish_images_title': 'Choisissez les images',
    'tour.publish_images_body':
      'Sélectionnez jusqu’à 13 exports de la galerie. Ils sont convertis et intégrés au paquet automatiquement.',
    'tour.publish_export_title': 'Exportez le paquet',
    'tour.publish_export_body':
      'La validation est permanente. Téléchargez le ZIP et importez-le dans votre compte portail.',
  ...
  de: {
    ...
    'page.reporter.widget.webgl_missing': 'Dieses Gerät kann keine Karten anzeigen (WebGL2 nicht verfügbar)',
    ...
    'page.publish.section.pricing': 'Preis',
    'page.publish.section.details': 'Kennzahlen',
    'page.publish.section.features': 'Ausstattung',
    'page.publish.section.contact': 'Kontakt und Agentur',
    'page.publish.offer.rent': 'Miete',
    'page.publish.offer.sale': 'Kauf',
    'page.publish.field.category': 'Kategorie',
    'page.publish.field.objectType': 'Objekttyp',
    'page.publish.field.refProperty': 'Referenz (EGRID oder eigene)',
    'page.publish.field.street': 'Strasse und Nummer',
    'page.publish.field.zip': 'PLZ',
    'page.publish.field.city': 'Ort',
    'page.publish.field.canton': 'Kanton',
    'page.publish.field.country': 'Land',
    'page.publish.field.situation': 'Lagebeschreibung',
    'page.publish.field.title': 'Inseratstitel',
    'page.publish.field.description': 'Beschreibung',
    'page.publish.field.availableFrom': 'Verfügbar ab (TT.MM.JJJJ)',
    'page.publish.field.url': 'Website',
    'page.publish.magic.button': 'Magisch ausfüllen',
    'page.publish.magic.busy': 'Wird geschrieben…',
    'page.publish.magic.confirm': 'Aktuellen Text ersetzen?',
    'page.publish.magic.failed': 'Generierung fehlgeschlagen. Nochmals versuchen.',
    'page.publish.magic.rateLimited':
      'Momentan zu viele Anfragen. Warte kurz und versuche es nochmals.',
    'page.publish.magic.hint':
      'Schreibt Titel und Beschreibung aus den Inseratsdaten. Die Daten bleiben massgebend: Prüfe den Text vor dem Publizieren.',
    'page.publish.field.sellingPrice': 'Verkaufspreis',
    'page.publish.field.rentNet': 'Nettomiete',
    'page.publish.field.rentExtra': 'Nebenkosten',
    'page.publish.field.priceUnit': 'Preiseinheit',
    'page.publish.unit.SELL': 'Gesamter Verkaufspreis',
    'page.publish.unit.SELLM2': 'Preis pro m2',
    'page.publish.unit.MONTHLY': 'Miete pro Monat',
    'page.publish.unit.WEEKLY': 'Miete pro Woche',
    'page.publish.unit.DAILY': 'Miete pro Tag',
    'page.publish.unit.YEARLY': 'Miete pro Jahr',
    'page.publish.unit.M2YEARLY': 'Miete pro m2 und Jahr',
    ...
    'page.publish.field.surfaceLiving': 'Wohnfläche (m2)',
    'page.publish.field.surfaceProperty': 'Grundstücksfläche (m2)',
    'page.publish.field.surfaceUsable': 'Nutzfläche (m2)',
    'page.publish.field.volume': 'Volumen (m3)',
    'page.publish.field.yearBuilt': 'Baujahr',
    'page.publish.field.yearRenovated': 'Renovationsjahr',
    ...
    'page.publish.field.agencyEmail': 'E-Mail',
    'page.publish.field.visitName': 'Kontakt für Besichtigungen',
    'page.publish.field.visitPhone': 'Telefon für Besichtigungen',
    'page.publish.field.visitRemark': 'Hinweis zur Besichtigung',
    'page.publish.feature.view': 'Aussicht',
    'page.publish.feature.fireplace': 'Cheminée',
    'page.publish.feature.cabletv': 'Kabelfernsehen',
    'page.publish.feature.elevator': 'Lift',
    'page.publish.feature.childFriendly': 'Kinderfreundlich',
    'page.publish.feature.parking': 'Parkplatz',
    'page.publish.feature.garage': 'Garage',
    'page.publish.feature.balcony': 'Balkon',
    'page.publish.feature.wheelchair': 'Rollstuhlgängig',
    'page.publish.feature.animalAllowed': 'Haustiere erlaubt',
    'page.publish.feature.newBuilding': 'Neubau',
    'page.publish.feature.oldBuilding': 'Altbau',
    'page.publish.feature.swimmingpool': 'Schwimmbad',
    'page.publish.feature.minergieGeneral': 'Minergie-Bauweise',
    ...
    'page.publish.images.moveUp': '{name} nach oben verschieben',
    'page.publish.images.moveDown': '{name} nach unten verschieben',
    'page.publish.images.remove': '{name} entfernen',
    'page.publish.validation.title': 'Validierung',
    'page.publish.validation.ok': 'Bereit für den Export. Alle Pflichtfelder sind erfasst.',
    'page.publish.issue.refRequired': 'Eine Objektreferenz ist erforderlich.',
    'page.publish.issue.zipInvalid': 'Schweizer PLZ haben 4 Stellen.',
    'page.publish.issue.cityRequired': 'Der Ort ist erforderlich.',
    ...
    'page.publish.issue.priceOnRequest':
      'Kein Preis erfasst. Das Inserat zeigt „Preis auf Anfrage“.',
    'page.publish.issue.noStreet': 'Ohne Strasse erhält das Inserat keinen Kartenpunkt.',
    'page.publish.issue.noImages': 'Keine Bilder ausgewählt.',
    'page.publish.issue.titleTruncated': 'Der Titel wird bei {max} Zeichen abgeschnitten.',
    'page.publish.issue.descriptionTruncated':
      'Die Beschreibung wird bei {max} Zeichen abgeschnitten.',
    'page.publish.issue.priceUnitDefaulted':
      'Keine Preiseinheit gesetzt. Es gilt die Vorgabe des Portals.',
    'page.publish.export.title': 'Export',
    'page.publish.export.package': 'Portalpaket herunterladen (.zip)',
    'page.publish.export.unload': 'unload.txt herunterladen',
  ...
  it: {
    ...
    'page.reporter.widget.webgl_missing': 'Questo dispositivo non può visualizzare mappe (WebGL2 non disponibile)',
    ...
    // Pagina Pubblica - pacchetto IDX 3.01 per i portali
    'page.publish.kicker': 'Pubblicazione portali',
    'page.publish.intro':
      'Prepara un annuncio immobiliare come pacchetto IDX 3.01 pronto per ImmoScout24, Homegate, newhome e Flatfox. Compila l’annuncio, scegli le immagini dalla galleria e scarica il pacchetto da caricare.',
    ...
    'page.publish.section.pricing': 'Prezzo',
    'page.publish.section.details': 'Dati tecnici',
    'page.publish.section.features': 'Dotazioni',
    'page.publish.section.contact': 'Contatto e agenzia',
    'page.publish.offer.rent': 'Affitto',
    'page.publish.offer.sale': 'Vendita',
    'page.publish.field.category': 'Categoria',
    'page.publish.field.objectType': 'Tipo di oggetto',
    'page.publish.field.refProperty': 'Riferimento (EGRID o proprio)',
    'page.publish.field.street': 'Via e numero',
    'page.publish.field.zip': 'NAP',
    'page.publish.field.city': 'Località',
    'page.publish.field.canton': 'Cantone',
    'page.publish.field.country': 'Paese',
    'page.publish.field.situation': 'Situazione',
    'page.publish.field.title': 'Titolo dell’annuncio',
    'page.publish.field.description': 'Descrizione',
    'page.publish.field.availableFrom': 'Disponibile dal (GG.MM.AAAA)',
    'page.publish.field.url': 'Sito web',
    'page.publish.magic.button': 'Compilazione magica',
    'page.publish.magic.busy': 'Scrittura in corso…',
    'page.publish.magic.confirm': 'Sostituire il testo attuale?',
    'page.publish.magic.failed': 'Generazione non riuscita. Riprova.',
    'page.publish.magic.rateLimited': 'Troppe richieste al momento. Attendi un attimo e riprova.',
    'page.publish.magic.hint':
      'Scrive titolo e descrizione dai dati dell’annuncio. I dati restano la fonte attendibile: controlla il testo prima di pubblicare.',
    'page.publish.field.sellingPrice': 'Prezzo di vendita',
    'page.publish.field.rentNet': 'Pigione netta',
    'page.publish.field.rentExtra': 'Spese accessorie',
    'page.publish.field.priceUnit': 'Unità di prezzo',
    'page.publish.unit.SELL': 'Prezzo di vendita totale',
    'page.publish.unit.SELLM2': 'Prezzo per m2',
    'page.publish.unit.MONTHLY': 'Pigione al mese',
    'page.publish.unit.WEEKLY': 'Pigione alla settimana',
    'page.publish.unit.DAILY': 'Pigione al giorno',
    'page.publish.unit.YEARLY': 'Pigione all’anno',
    'page.publish.unit.M2YEARLY': 'Pigione per m2 all’anno',
    ...
    'page.publish.field.surfaceLiving': 'Superficie abitabile (m2)',
    'page.publish.field.surfaceProperty': 'Superficie del terreno (m2)',
    'page.publish.field.surfaceUsable': 'Superficie utile (m2)',
    'page.publish.field.volume': 'Volume (m3)',
    'page.publish.field.yearBuilt': 'Anno di costruzione',
    'page.publish.field.yearRenovated': 'Anno di rinnovo',
    'page.publish.field.numberOfFloors': 'Piani dell’edificio',
    'page.publish.field.agencyId': 'ID agenzia',
    'page.publish.agencyIdHint':
      'Assegnato dal portale con il contratto di pubblicazione. Lascia vuoto se lo compila il tuo software.',
    'page.publish.field.agencyName': 'Nome dell’agenzia',
    'page.publish.field.agencyReference': 'Persona di contatto',
    'page.publish.field.agencyPhone': 'Telefono',
    'page.publish.field.agencyEmail': 'E-mail',
    'page.publish.field.visitName': 'Contatto per le visite',
    'page.publish.field.visitPhone': 'Telefono per le visite',
    'page.publish.field.visitRemark': 'Nota sulle visite',
    'page.publish.feature.view': 'Vista',
    'page.publish.feature.fireplace': 'Camino',
    'page.publish.feature.cabletv': 'Televisione via cavo',
    'page.publish.feature.elevator': 'Ascensore',
    'page.publish.feature.childFriendly': 'Adatto ai bambini',
    'page.publish.feature.parking': 'Posteggio',
    'page.publish.feature.garage': 'Garage',
    'page.publish.feature.balcony': 'Balcone',
    'page.publish.feature.wheelchair': 'Accessibile in sedia a rotelle',
    'page.publish.feature.animalAllowed': 'Animali ammessi',
    'page.publish.feature.newBuilding': 'Nuova costruzione',
    'page.publish.feature.oldBuilding': 'Edificio antico',
    'page.publish.feature.swimmingpool': 'Piscina',
    'page.publish.feature.minergieGeneral': 'Costruzione Minergie',
    'page.publish.feature.minergieCertified': 'Certificato Minergie',
    'page.publish.images.title': 'Immagini dell’annuncio',
    'page.publish.images.hint':
      'Scegli fino a 13 immagini dalla galleria. Vengono convertite in JPEG e inserite nel pacchetto per il portale.',
    'page.publish.images.empty':
      'Nessuna immagine in galleria. Crea prima degli export nel Reporter oppure salva schermate dalle app cartografiche.',
    'page.publish.images.count': '{n}/13 selezionate',
    'page.publish.images.titlePlaceholder': 'Titolo immagine (facoltativo)',
    'page.publish.images.failed': 'Alcune immagini non sono state preparate: {names}',
    'page.publish.images.moveUp': 'Sposta {name} in alto',
    'page.publish.images.moveDown': 'Sposta {name} in basso',
    'page.publish.images.remove': 'Rimuovi {name}',
    'page.publish.validation.title': 'Validazione',
    'page.publish.validation.ok': 'Pronto per l’export. Tutti i campi obbligatori sono compilati.',
    'page.publish.issue.refRequired': 'È necessario un riferimento dell’oggetto.',
    'page.publish.issue.zipInvalid': 'I NAP svizzeri hanno 4 cifre.',
    'page.publish.issue.cityRequired': 'La località è obbligatoria.',
    'page.publish.issue.countryInvalid': 'Il paese deve essere un codice di 2 lettere.',
    'page.publish.issue.titleRequired': 'È necessario un titolo dell’annuncio.',
    'page.publish.issue.descriptionRequired': 'È necessaria una descrizione.',
    'page.publish.issue.typeRequired': 'Scegli un tipo di oggetto.',
    'page.publish.issue.priceUnitMismatch':
      'L’unità di prezzo non corrisponde al tipo di offerta.',
    'page.publish.issue.dateInvalid': 'Usa il formato GG.MM.AAAA.',
    'page.publish.issue.yearInvalid': 'Gli anni hanno 4 cifre.',
    'page.publish.issue.agencyIdMissing':
      'Nessun ID agenzia. I portali rifiutano i caricamenti senza ID.',
    'page.publish.issue.priceOnRequest':
      'Nessun prezzo indicato. L’annuncio mostrerà «prezzo su richiesta».',
    'page.publish.issue.noStreet': 'Senza via l’annuncio non ottiene un punto sulla mappa.',
    'page.publish.issue.noImages': 'Nessuna immagine selezionata.',
    'page.publish.issue.titleTruncated': 'Il titolo viene troncato a {max} caratteri.',
    'page.publish.issue.descriptionTruncated': 'La descrizione viene troncata a {max} caratteri.',
    'page.publish.issue.priceUnitDefaulted':
      'Nessuna unità di prezzo impostata. Si applica il valore predefinito del portale.',
    'page.publish.export.title': 'Export',
    'page.publish.export.package': 'Scarica il pacchetto per il portale (.zip)',
    'page.publish.export.unload': 'Scarica unload.txt',
    'page.publish.export.copy': 'Copia il record IDX',
    ...
    'page.publish.guide.smg.title': 'ImmoScout24 e Homegate (SMG)',
    'page.publish.guide.smg.body':
      'Gli annunci raggiungono entrambi i portali tramite il feed SMG. Con un contratto di pubblicazione professionale ricevi un ID agenzia e le credenziali FTP. Carica le cartelle data e images su ftp.homegate.ch. Il file sostituisce tutti i tuoi annunci pubblicati e le elaborazioni avvengono circa tre volte al giorno.',
    'page.publish.guide.newhome.title': 'newhome',
    'page.publish.guide.newhome.body':
      'I conti business (FLEX) possono attivare l’interfaccia di importazione sotto My newhome, Servizi, Interfacce di importazione e caricare questo pacchetto con le credenziali generate.',
    'page.publish.guide.flatfox.title': 'Flatfox',
    'page.publish.guide.flatfox.body':
      'Flatfox accetta pacchetti IDX dai software immobiliari e offre un’API REST per i conti aziendali. Gli annunci privati si inseriscono direttamente nell’interfaccia web di Flatfox.',
    'page.publish.guide.disclaimer':
      'Questa pagina prepara un pacchetto pronto per i portali. La pubblicazione avviene con il tuo contratto e le tue credenziali.',
    ...
    'tour.publish_form_title': 'Descrivi l’oggetto',
    'tour.publish_form_body':
      'Cerca un indirizzo per precompilare i dati della particella, poi completa i dettagli dell’annuncio.',
    'tour.publish_images_title': 'Scegli le immagini',
    'tour.publish_images_body':
      'Seleziona fino a 13 export della galleria. Vengono convertiti e inseriti nel pacchetto automaticamente.',
    'tour.publish_export_title': 'Esporta il pacchetto',
    'tour.publish_export_body':
      'La validazione è sempre attiva. Scarica lo ZIP e caricalo nel tuo account del portale.',
